    ...
    @include("connection.php");
    {
        if(isset($_POST['SignUp']))
        {
            ...
            if(isset($user_firstname) && isset($user_lastname) && isset($user_email) && isset($user_pno) && isset($user_pass) && isset($user_cpass))
            {
                ...
                $sql = "SELECT * FROM `art_gallary` WHERE useremail_id='$user_email' && password = '$user_pass' ";
                ...
                else
                {
                    ...
                    {
                        $insert = "INSERT INTO art_gallary(userfirstname , userlastname , useremail_id , userphno  , password , confirmpassword)
                        VALUES('$user_firstname','$user_lastname','$user_email','$user_pno','$user_pass','$user_cpass')";
            ...
            <form action="#" method="post" onsubmit="return validation()" class="bg-light">
                ...
                <div class="user-details">
                    <div class="input-box">
                        ...
                        <input type="text" name="firstname" id="firstname" class="form-input" placeholder="name" autocomplete="off">
                        <span id="f_name" class="text-danger font-weight-bold"></span>
                    </div>

                    <div class="input-box">
                        <span class="details">Last Name</span>
                        <input type="text" name="lastname" id="lastname" class="form-input" placeholder="lastname" autocomplete="off">
                ...
                <font size="5" color="black">
                    <center>Already have an account?<a href="l.php">Login</a></center>
                </font>
